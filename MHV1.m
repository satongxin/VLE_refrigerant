function ln_phi=MHV1(P,T,component,phase_flag)
...
a=b*(x'*(a_ii./b_ii)+g_E_res/-0.53087+R*T/-0.53087*(x'*log(b./b_ii)));
...
ln_phi_2=a_ii./b_ii/R/T+lngamma/-0.53087+log(b./b_ii)/-0.53087+(b_ii/b-1)/-0.53087;
